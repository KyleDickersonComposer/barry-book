...
% Canonical chord semantics:
% - Baseline quality words: min / maj
% - Superscript extensions and alterations
% - Small raised accidental signs in alterations
