...
When the \twoFive is in a minor key, you simply play the minor version of the \twoChord chord. Notice that we are playing the minor scale with the natural sixth and the natural seventh on the \MusicChord{root=C, quality={min6}}.
