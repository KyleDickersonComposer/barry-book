...
\newglossaryentry{scale-maps}{%
	name={scale maps},
	description={A preparatory exercise for linear improvisation that gives a \emph{map} of scales that outlines the changes of the tune.}
}
